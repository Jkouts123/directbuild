          ...
          <RevealOnScroll direction="left" delay={0}>
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-orange-safety/20 backdrop-blur-sm">
                <Wind className="text-orange-safety" size={24} />
              </div>
              <h1 className="text-3xl sm:text-4xl font-bold text-white drop-shadow-lg">HVAC Estimator</h1>
            </div>
          </RevealOnScroll>
          <RevealText
            as="p"
            ...
            stagger={0.02}
          >
            Get an instant ballpark estimate for your air conditioning project. Answer a few questions and we'll calculate typical costs based on 2026 Australian market rates.
          </RevealText>
        </div>
      </div>
