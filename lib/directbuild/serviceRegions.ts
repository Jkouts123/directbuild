...
const seeds: RegionSeed[] = [
  ...
  { label: "Melbourne - CBD / Inner", state: "VIC", metro: "Melbourne", aliases: ["Melbourne CBD", "Inner Melbourne"], exampleAreas: ["Melbourne", "Southbank", "Richmond"], defaultCompetitorSearchArea: "Melbourne VIC Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Melbourne - Eastern Suburbs", state: "VIC", metro: "Melbourne", aliases: ["Eastern Melbourne"], exampleAreas: ["Box Hill", "Doncaster", "Ringwood"], defaultCompetitorSearchArea: "Box Hill VIC Australia", regionFitNote: METRO_NOTE },
  { label: "Melbourne - South East", state: "VIC", metro: "Melbourne", aliases: ["South East Melbourne"], exampleAreas: ["Dandenong", "Narre Warren", "Cranbourne"], defaultCompetitorSearchArea: "Dandenong VIC Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Melbourne - Northern Suburbs", state: "VIC", metro: "Melbourne", aliases: ["Northern Melbourne"], exampleAreas: ["Preston", "Reservoir", "Epping"], defaultCompetitorSearchArea: "Preston VIC Australia", regionFitNote: METRO_NOTE },
  { label: "Melbourne - Western Suburbs", state: "VIC", metro: "Melbourne", aliases: ["Western Melbourne"], exampleAreas: ["Footscray", "Werribee", "Point Cook"], defaultCompetitorSearchArea: "Werribee VIC Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Brisbane - CBD / Inner", state: "QLD", metro: "Brisbane", aliases: ["Brisbane CBD", "Inner Brisbane"], exampleAreas: ["Brisbane", "Fortitude Valley", "New Farm"], defaultCompetitorSearchArea: "Brisbane QLD Australia", regionFitNote: METRO_NOTE },
  { label: "Brisbane - Northside", state: "QLD", metro: "Brisbane", aliases: ["North Brisbane"], exampleAreas: ["Chermside", "Nundah", "Aspley"], defaultCompetitorSearchArea: "Chermside QLD Australia", regionFitNote: METRO_NOTE },
  { label: "Brisbane - Southside", state: "QLD", metro: "Brisbane", aliases: ["South Brisbane"], exampleAreas: ["Carindale", "Sunnybank", "Mount Gravatt"], defaultCompetitorSearchArea: "Mount Gravatt QLD Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Gold Coast", state: "QLD", regionType: "regional_city", aliases: ["Gold Coast QLD"], exampleAreas: ["Southport", "Robina", "Burleigh Heads"], defaultCompetitorSearchArea: "Southport QLD Australia", regionFitNote: VALUE_NOTE },
  { label: "Sunshine Coast", state: "QLD", regionType: "regional_city", aliases: ["Sunshine Coast QLD"], exampleAreas: ["Maroochydore", "Noosa", "Caloundra"], defaultCompetitorSearchArea: "Maroochydore QLD Australia", regionFitNote: VALUE_NOTE },
  ...
  { label: "Perth - CBD / Inner", state: "WA", metro: "Perth", aliases: ["Perth CBD", "Inner Perth"], exampleAreas: ["Perth", "Subiaco", "Victoria Park"], defaultCompetitorSearchArea: "Perth WA Australia", regionFitNote: METRO_NOTE },
  { label: "Perth - Northern Suburbs", state: "WA", metro: "Perth", aliases: ["North Perth"], exampleAreas: ["Joondalup", "Wanneroo", "Balcatta"], defaultCompetitorSearchArea: "Joondalup WA Australia", regionFitNote: METRO_NOTE },
  { label: "Perth - Southern Suburbs", state: "WA", metro: "Perth", aliases: ["South Perth"], exampleAreas: ["Canning Vale", "Armadale", "Cockburn"], defaultCompetitorSearchArea: "Canning Vale WA Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Adelaide - CBD / Inner", state: "SA", metro: "Adelaide", aliases: ["Adelaide CBD", "Inner Adelaide"], exampleAreas: ["Adelaide", "Norwood", "Unley"], defaultCompetitorSearchArea: "Adelaide SA Australia", regionFitNote: METRO_NOTE },
  { label: "Adelaide - North", state: "SA", metro: "Adelaide", aliases: ["Northern Adelaide"], exampleAreas: ["Salisbury", "Elizabeth", "Gawler"], defaultCompetitorSearchArea: "Elizabeth SA Australia", regionFitNote: METRO_NOTE },
  { label: "Adelaide - South", state: "SA", metro: "Adelaide", aliases: ["Southern Adelaide"], exampleAreas: ["Noarlunga", "Morphett Vale", "Aberfoyle Park"], defaultCompetitorSearchArea: "Marion SA Australia", regionFitNote: METRO_NOTE },
  ...
  { label: "Canberra - Inner North / Inner South", state: "ACT", metro: "Canberra", aliases: ["Inner Canberra"], exampleAreas: ["Braddon", "Kingston", "Griffith"], defaultCompetitorSearchArea: "Canberra ACT Australia", regionFitNote: VALUE_NOTE },
